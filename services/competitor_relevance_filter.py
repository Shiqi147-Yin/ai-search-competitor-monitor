...
def classify_source_authority(
    ...
    official_domains = [
        d.lstrip("www.")
        for d in sources.get("official_domains", [])
    ]
...
def classify_relevance(
    ...
    authority, official = classify_source_authority(
        url,
        competitor,
    )
    ...
    authority_bonus = {
        "official": 0.2,
        "first_party_ecosystem": 0.1,
        "reputable_third_party": 0.05,
        "unknown": 0,
        "low_value_aggregator": -0.2,
    }
